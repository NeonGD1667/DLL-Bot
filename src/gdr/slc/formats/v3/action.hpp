...
struct Macro : gdr::Replay<Macro, input> {
    ...
    Macro()
        : Replay("xdBot", xdBotVersion.c_str()) {}
...
public:
    ...
    /**
     * Convert current Macro inputs to SLC v2.
     *
     * SLC v2:
     *   Jump  = 1
     *   Left  = 2
     ...
     *   TPS = 7
     */
    static slc::v2::Replay<> toSLC2();

    /**
     * Convert current Macro inputs to SLC v3.
     *
     * SLC v3 uses ActionAtom internally.
     */
    static slc::v3::Replay<> toSLC3();

    /**
     * Import SLC v2 replay into the current Macro.
     */
    static bool fromSLC2(
        const slc::v2::Replay<>& replay
    );

    /**
     * Import SLC v3 replay into the current Macro.
     */
    static bool fromSLC3(
        const slc::v3::Replay<>& replay
    );
