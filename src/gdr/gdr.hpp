    ...
    static Self importData(
        ...
        if (offset == 1) {
            ...
            if (splitVer.size() <= 3) {
                ...
                auto macroVer = getVersion(splitVer);
                auto checkVer = getVersion(realVer);
        ...
        for (json const& inputJson : replayJson["inputs"]) {
            ...
            input.frame =
                inputJson["frame"].get<int>() + offset;
        ...
        for (
            ...
            frameFix.frame =
                frameFixJson["frame"].get<int>() + offset;
            ...
            if (frameFixJson.contains("player1")) {
                ...
                if (frameFixJson.contains("player2")) {
                    frameFix.p2.pos =
                        dataFromString(
                ...
                frameFix.p1.pos = ccp(
                    frameFixJson["player1X"],
                    frameFixJson["player1Y"]
                );
                ...
                if (
                    ...
                    frameFix.p2.pos = ccp(
                        frameFixJson["player2X"],
                        frameFixJson["player2Y"]
                    );
