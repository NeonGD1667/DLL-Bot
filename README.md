...
Developed and maintained by **Homeless Team**.

This project includes code derived from **xdBot** by **Zilko**. Full credit goes to the original author for the foundation and contributions to the Geometry Dash modding community.

Special thanks to **Zilko** for creating xdBot.

## Disclaimer

DLL Bot is an unofficial Geometry Dash modification and is not affiliated with or endorsed by RobTop Games.

Please respect the original license of DLL Bot and all third-party libraries used by this project.

## License

This project is licensed under the terms specified in the [`LICENSE`](LICENSE) file.

Third-party components may be distributed under their own respective licenses.
